## tgctl message forward-batch

Forward multiple messages at once

```
tgctl message forward-batch [flags]
```

### Examples

```
  tgctl message forward-batch --chat @dest --from-chat @src --message-ids '[10,11,12]'
```
