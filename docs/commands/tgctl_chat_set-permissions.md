## tgctl chat set-permissions

Set the default permissions for all members

```
tgctl chat set-permissions [flags]
```

### Examples

```
  tgctl chat set-permissions --chat @group \
...
```
  ...
  -h, --help                               help for set-permissions
      ...
      --use-independent-chat-permissions   treat each permission independently
```
