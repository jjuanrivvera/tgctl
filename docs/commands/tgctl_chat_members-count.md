## tgctl chat members-count

Show the number of members in a chat

```
tgctl chat members-count [flags]
```

### Examples

```
  tgctl chat members-count --chat @group
```
