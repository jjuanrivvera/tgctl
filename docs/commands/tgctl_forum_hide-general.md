## tgctl forum hide-general

Hide the General forum topic (also closes it)

```
tgctl forum hide-general [flags]
```

### Examples

```
  tgctl forum hide-general --chat @group
```
