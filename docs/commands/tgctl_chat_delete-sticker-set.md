## tgctl chat delete-sticker-set

Remove the group sticker set from a supergroup

```
tgctl chat delete-sticker-set [flags]
```

### Examples

```
  tgctl chat delete-sticker-set --chat @group
```
...
```
  ...
  -h, --help          help for delete-sticker-set
```
