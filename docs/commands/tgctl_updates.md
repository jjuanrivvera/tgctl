...
Fetch incoming updates (long polling)

### Synopsis

Read updates with getUpdates. Note: getUpdates conflicts with a set webhook —
...
* [tgctl updates get](tgctl_updates_get.md)	 - Get pending updates
