...
func TestConfig_SaveLoadRoundTrip(t *testing.T) {
	...
	require.NoError(t, c.SetProfile("prod", Profile{BaseURL: "https://api.telegram.org", AuthMethod: "bot-token", BotID: "123"}))
...
func TestResolveProfileName_Precedence(t *testing.T) {
	...
	t.Setenv("TGCTL_PROFILE", "fromenv")
...
func TestValidateBaseURL(t *testing.T) {
	assert.NoError(t, ValidateBaseURL("https://api.telegram.org"))
