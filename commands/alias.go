...
// expansion. Built-ins always win, so an alias can never shadow `auth`, `message`, etc.
...
func init() {
	register(func(root *cobra.Command) {
		...
		setCmd := &cobra.Command{
			...
			Example: `  tgctl alias set ping "bot info"
  tgctl alias set notify "message send --chat @me"`,
